...
const heroHotspots = [
  { label: "Destinations", to: "/destinations", icon: "map" },
  { label: "Resources", to: "/resources", icon: "compass" },
  {
    label: "Accommodation",
    href: AFFILIATE_OFFERS.hotels.url,
    icon: "bed",
    external: true,
  },
  { label: "Flights", to: "/search/flights", icon: "plane" },
];
...
const steps = [
  {
    ...
    body: "Economy, Employment, Education, and Ecology: four lenses that reveal what matters on any trip.",
  },
  {
    icon: "compass",
    title: "Partner with AI for research",
    body: "Let our prompts handle the data gathering. Then, check the findings with locals and official sources to ensure they hold up.",
  },
  {
    icon: "shield",
    title: "Book with purpose",
    body: "Choose partners that align with the four domains so your spending supports local people and places.",
  },
];
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-content relative py-20 sm:py-28 text-white">
          <div className="max-w-3xl animate-fade-up">
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-3xl">
              {heroHotspots.map((spot) => {
                const className =
                  "group rounded-2xl bg-white/10 ring-1 ring-white/20 px-4 py-3.5 backdrop-blur transition duration-300 ease-smooth hover:bg-white/20 hover:-translate-y-1";
                const content = (
                  <span className="flex items-center gap-2.5 text-sm font-bold">
                    <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-white/15">
                      <Icon name={spot.icon} className="w-4 h-4" />
                    </span>
                    {spot.label}
                  </span>
                );
                ...
                return (
                  <Link key={spot.label} to={spot.to} className={className}>
                    {content}
                  </Link>
                );
              })}
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              ...
              <Link to="/prompts" className="btn border-2 border-white/40 text-white hover:bg-white/10 backdrop-blur">
      ...
      {/* 2. Stats strip — Quick visual proof */}
      ...
      <section className="bg-cream pb-10 sm:pb-12">
        <div className="container-content pt-12 sm:pt-16">
          ...
          <div className="mt-12 relative overflow-hidden rounded-4xl bg-gradient-to-br from-ocean to-leaf text-white p-8 sm:p-12">
      ...
      {/* 10. Mission strip — The Closing CTA */}
