  ...
  return (
    <div className={className}>
      ...
      <p className="mt-2 text-slate-700 font-medium max-w-3xl leading-relaxed">
        Every Atlas destination prompt asks your AI to work through these four Gyroscope Protocol
        work categories in Step 2: Preparation. Use them as a checklist before you copy and paste.
      </p>
